...
public class Question {
  ...
  public static Question fromEntity(Entity entity) {
    return new Question(entity.getProperty(DataManager.CASE_DATA_ID).toString(),
        entity.getProperty("question").toString(), entity.getProperty("answer").toString(),
  ...
  public String toString() {
    return "Question [caseDataId=" + caseDataId + ", question=" + question + ", answer=" + answer
