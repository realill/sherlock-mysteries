...
public class ActionsMvcTest {
  ...
  public void init() throws Exception {
    if (!wasDataImported) {
      ...
      assetsImportManager.importCaseAssets(Mockito.mock(HttpRequestInitializer.class), "test-case",
          "caseDataId");
      dataManager.addCase(new Case("clay-pots", "caseDataId", "Clay Pots", ImmutableList.of(),
          "category", true, null));
  ...
  public void inputunknown_lookup() throws Exception {
    ...
    tester.request(TesterRequest.action("input.unknown").input("scotland yard"))
        .assertSsmlContains("scotland yard");
  }

  @Test
  public void startCase_clues() throws Exception {
    tester.request(TesterRequest.action("start-case")).assertSsmlContains("london map")
  ...
  public void navigate_clues() throws Exception {
    tester.request(TesterRequest.action("start-case")).assertSsmlContains("map")
        .assertSsmlContains("newspaper");
    tester.navigate("4 Whitehall Place")
        .assertSsmlContains("They also will be available on you game log page")
  ...
  public void navigate_audio() throws Exception {
    tester.request(TesterRequest.action("start-case")).assertSsmlContains("You are welcomed");
    tester.request(TesterRequest.action("navigate").param("location", "101a regent street"))
        .assertSsmlContains("Stephen Cook").assertEndConversation();;
  }
  ...
  public void navigate_audioOnSpeakerEnds() throws Exception {
    tester.request(TesterRequest.action("start-case")).assertSsmlContains("You are welcomed");
    tester.request(
        TesterRequest.action("navigate").param("location", "101a regent street").speakerDevice())
        .assertSsmlContains("Stephen Cook").assertNotEndConversation();
  }

  @Test
  public void navigate_simple() throws Exception {
    tester.request(TesterRequest.action("start-case")).assertSsmlContains("You are welcomed");
    tester.request(TesterRequest.action("navigate").param("location", "221B Baker Street"))
        .assertSsmlContains("left the house");
    tester.request(TesterRequest.action("status")).assertSsmlContains(" 1 ")
  ...
  public void listClues_hasCaseClues() throws Exception {
    tester.request(TesterRequest.action("start-case"));
    tester.request(TesterRequest.action("list-clues")).assertSsmlContains("london map")
        .assertSsmlContains("newspaper");
    tester.navigate("4 Whitehall Place");
    tester.request(TesterRequest.action("list-clues")).assertSsmlContains("london map")
        .assertSsmlContains("newspaper").assertSsmlContains("portrait");
    tester.request(TesterRequest.action("list-clues").param("clue", "london map"))
        .assertSsmlContains("london map").assertSsmlContains("game log page");
  }

  @Test
  public void lookupLocation_findLocation() throws Exception {
    tester.request(TesterRequest.action("start-case"));
    tester.request(TesterRequest.action("lookup").param("location", "test location"))
  ...
  public void lookupLocation_findClue() throws Exception {
    tester.request(TesterRequest.action("start-case"));
    tester.request(TesterRequest.action("lookup").param("clue", "queen victoria"))
  ...
  public void lookupLocation_generalQuery() throws Exception {
    tester.request(TesterRequest.action("start-case"));
    tester.navigate("4 Whitehall Place");
    tester.request(TesterRequest.action("lookup").param("query", "queen victoria"))
        .assertSsmlDoesNotContain("portrait").assertSsmlContains("Buckingham Palace");
    tester.request(TesterRequest.action("lookup").param("query", "newspaper"))
  ...
  public void finishConfirmed_contexts() throws Exception {
    ...
    tester.request(TesterRequest.action("finish-confirm"))
        .assertSsmlContains("Where does Queen Victoria live").assertOutContext("question");
  }
  ...
  public void finish_answerQuestions() throws Exception {
    ...
    tester.request(TesterRequest.action("answer").param("answer", "My first answer"))
        .assertSsmlContains("My first answer").assertOutContext("answer-confirm");
    ...
    tester.request(TesterRequest.action("answer-confirm").param("answer", "no one"))
        .assertSsmlContains("answered all the questions").assertSsmlContains("goal of this")
  ...
  public void answerQuestions_repeat() throws Exception {
    ...
    tester.request(TesterRequest.action("finish-answer-repeat"))
        .assertSsmlContains("Where does Queen Victoria live");
    tester.request(TesterRequest.action("answer").param("answer", "My first answer"));
    tester.request(TesterRequest.action("answer-confirm").param("answer", "My first answer"));
    tester.request(TesterRequest.action("finish-answer-repeat"))
  ...
  public void validateAnswers_allCorrect() throws Exception {
    ...
    tester.request(TesterRequest.action("validate-answer-confirm"))
        .assertSsmlContains("4 shillings").assertSsmlContains("2 pence");
    tester.request(TesterRequest.action("validate-answer-confirm"))
        .assertSsmlContains("4 shillings").assertSsmlContains("2 pence");
    tester.request(TesterRequest.action("validate-answer-confirm")).assertSsmlContains("all 3")
        .assertSsmlContains("9 shillings").assertSsmlContains("2 pence");
  ...
  public void validateAnswers_allIncorrect() throws Exception {
    toValidation();
    tester.request(TesterRequest.action("validate-answer-reject"))
        .assertSsmlDoesNotContain("shilling");
    tester.request(TesterRequest.action("validate-answer-reject"))
        .assertSsmlDoesNotContain("shilling");
    tester.request(TesterRequest.action("validate-answer-reject"))
        .assertSsmlContains("you haven't help").assertSsmlContains("legwork");
  ...
  public void validateAnswers_oneReject() throws Exception {
    ...
    tester.request(TesterRequest.action("validate-answer-confirm"))
        .assertSsmlContains("5 shillings").assertSsmlContains("2 out of 3");
  ...
  public void validate_repeat() throws Exception {
    toValidation();
    tester.request(TesterRequest.action("finish-validate-repeat"))
        .assertSsmlContains("where does queen victoria")
        .assertOutContext("validate-answer-confirm");
    tester.request(TesterRequest.action("validate-answer-confirm"));
    tester.request(TesterRequest.action("finish-validate-repeat"))
        .assertSsmlContains("who was robbed").assertOutContext("validate-answer-confirm");
    tester.request(TesterRequest.action("validate-answer-confirm"));
    tester.request(TesterRequest.action("finish-validate-repeat")).assertSsmlContains("my name")
        .assertOutContext("validate-answer-confirm");
  }
  ...
  public void news_all() throws Exception {
    tester.startCase();
    tester.request(TesterRequest.action("newspaper").param("article", "all"))
  ...
  public void news_crime() throws Exception {
    tester.startCase();
    tester.request(TesterRequest.action("newspaper").param("article", "Crime"))
        .assertSsmlContains("crime");
  }
